...
const Cart = () => {
  ...
  //   if ( < cart.productByTitle.quantity) setQuantity(quantity + 1);
              ...
              <>
                ...
                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                  <div className="flex w-2/5">
                    <div className="w-20">
                      <img className="h-24" src={product.product.images[0]} alt="" />
                    </div>
                    <div className="flex flex-col justify-between ml-4 flex-grow">
                      <span className="font-bold text-sm">{product.product.title}</span>
                      <span className="text-red-500 text-xs">Product Id : {product.productId}</span>
                      <a className="font-semibold hover:text-red-500 text-gray-500 text-xs" onClick={() =>
                        updateCart(
                          product.productId,
                          0,
                          true,
                  ...
                  <span className="text-center w-1/5 font-semibold text-sm">THB{product.product.price}</span>
                  <span className="text-center w-1/5 font-semibold text-sm">THB{product.product.price * product.quantity}</span>
                </div>
