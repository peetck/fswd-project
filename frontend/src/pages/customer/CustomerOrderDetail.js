        ...
        <div className="flex shadow-md">
          <div className="w-full">
              ...
              data.order.products.map((product, index) => (
                <>
                  <div className="flex pl-20 pr-20 m-10 p-5 border-b shadow">
                    <div className="w-3/12">{product.title}</div>
                    <div className="w-1/12 pl-1">{product.color}</div>
                    <div className="w-1/12 pl-1">{product.size}</div>
                    <div className="w-1/12 pl-5">{product.quantity}</div>
                    ...
                    {product.type === "PromotionProduct" ? (
                      <>
                        ...
                        <div className="w-1/12 pl-12">-{product.percent}%</div>
                      ...
                      <>
                        ...
                        <div className="w-1/12">{product.price}</div>
                      </>
                    )}
                  </div>
                </>
            ...
            <div className="flex flex-row-reverse border-t ml-10 mr-10 mb-10">
              <div className="mt-10">
                {String(data.order.deliveryStatus) === "false" ? (
                ...
                {data && data.order.updatedAt ? (
                  <h1>Update Status At : {data.order.updatedAt}</h1>
                ) : (
                  <></>
                )}
              </div>
